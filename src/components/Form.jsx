...
const Form = ({onCalculateMortgage, onReset}) => {
  ...
  function validate(){
    ...
    if(!values.amount){newErrors.amount = "This field is required"}
    if(!values.term){newErrors.term = "This field is required"}
    if(!values.rate){newErrors.rate = "This field is required"}
